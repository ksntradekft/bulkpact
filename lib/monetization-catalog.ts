...
export const MONETIZATION_PLANS: MonetizationPlan[] = [
  { code:'BUYER_FREE', audience:'BUYER', nameHu:'Free', nameEn:'Free', priceMonthly:0, priceYearly:0, currency:'EUR',
    ...
    entitlements:{aiTranslation:false,responseSla:'standard',successFeePct:1.5,exportTools:false,teamSeats:1}},
  { code:'BUYER_BUSINESS', audience:'BUYER', nameHu:'Business', nameEn:'Business', priceMonthly:29, priceYearly:290, currency:'EUR', featured:true,
    ...
    featuresHu:['Minden Free funkció','Landed-cost nézet','Korábbi hozzáférés kiemelt dealekhez','Buyer demand jelzés','2 felhasználó','1,5% tranzakciós díj'],
    featuresEn:['Everything in Free','Landed-cost view','Earlier access to selected deals','Buyer demand signals','2 users','1.5% transaction fee'],
    entitlements:{aiTranslation:true,responseSla:'48h',successFeePct:1.5,exportTools:true,teamSeats:2}},
  { code:'BUYER_PRO', audience:'BUYER', nameHu:'Pro Buying', nameEn:'Pro Buying', priceMonthly:79, priceYearly:790, currency:'EUR',
    ...
    featuresHu:['Minden Business funkció','Prioritásos allocation','Haladó vásárlási riportok','Demand intelligence','Exportálható adatok','5 felhasználó','1,5% tranzakciós díj'],
    featuresEn:['Everything in Business','Priority allocation','Advanced purchasing reports','Demand intelligence','Exportable data','5 users','1.5% transaction fee'],
    entitlements:{aiTranslation:true,responseSla:'24h',successFeePct:1.5,exportTools:true,teamSeats:5}},
  { code:'BUYER_ENTERPRISE', audience:'BUYER', nameHu:'Enterprise', nameEn:'Enterprise', priceMonthly:null, priceYearly:null, currency:'EUR',
    ...
    featuresHu:['Korlátlan felhasználó','1,5% tranzakciós díj','Dedikált account manager','Egyedi riport/API','Több telephely kezelése'],
    featuresEn:['Unlimited users','1.5% transaction fee','Dedicated account manager','Custom reporting/API','Multi-location management'],
    entitlements:{aiTranslation:true,responseSla:'custom',successFeePct:1.5,exportTools:true,teamSeats:null}},
  ...
  { code:'MFG_STARTER', audience:'MANUFACTURER', nameHu:'Supplier Starter', nameEn:'Supplier Starter', priceMonthly:0, priceYearly:0, currency:'EUR',
    ...
    featuresHu:['1 aktív Group Order','Beszállítói profil','Alap fill-rate statisztika','1,5% Group Order platformdíj'],
    featuresEn:['1 active Group Order','Supplier profile','Basic fill-rate analytics','1.5% Group Order platform fee'],
    entitlements:{activeGroupOrders:1,groupOrderFeePct:1.5,featuredProfile:false,analytics:'basic',monthlyBoostCredits:0,monthlyLeadCredits:0,verificationDiscountPct:0,teamSeats:1}},
  { code:'MFG_BASIC', audience:'MANUFACTURER', nameHu:'Supplier Basic', nameEn:'Supplier Basic', priceMonthly:39, priceYearly:390, currency:'EUR', featured:true,
    ...
    featuresHu:['5 aktív Group Order','Verification kedvezmény','Alap analitika','1 boost kredit / hó','1,5% Group Order platformdíj','2 felhasználó'],
    featuresEn:['5 active Group Orders','Verification discount','Basic analytics','1 boost credit / month','1.5% Group Order platform fee','2 users'],
    entitlements:{activeGroupOrders:5,groupOrderFeePct:1.5,featuredProfile:false,analytics:'basic',monthlyBoostCredits:1,monthlyLeadCredits:5,verificationDiscountPct:25,teamSeats:2}},
  { code:'MFG_PRO', audience:'MANUFACTURER', nameHu:'Supplier Pro', nameEn:'Supplier Pro', priceMonthly:99, priceYearly:990, currency:'EUR',
    ...
    featuresHu:['20 aktív Group Order','Kiemelt beszállítói profil','3 boost kredit / hó','Buyer demand insight','Haladó analitika','1,5% Group Order platformdíj','5 felhasználó'],
    featuresEn:['20 active Group Orders','Featured supplier profile','3 boost credits / month','Buyer demand insights','Advanced analytics','1.5% Group Order platform fee','5 users'],
    entitlements:{activeGroupOrders:20,groupOrderFeePct:1.5,featuredProfile:true,analytics:'advanced',monthlyBoostCredits:3,monthlyLeadCredits:20,verificationDiscountPct:50,teamSeats:5}},
  ...
  { code:'WHS_STARTER', audience:'WHOLESALER', nameHu:'Wholesale Starter', nameEn:'Wholesale Starter', priceMonthly:0, priceYearly:0, currency:'EUR',
    ...
    featuresHu:['1 aktív Group Order','Alap telítettségi statisztika','1,5% Group Order platformdíj'], featuresEn:['1 active Group Order','Basic fill-rate analytics','1.5% Group Order platform fee'],
    entitlements:{activeGroupOrders:1,groupOrderFeePct:1.5,featuredProfile:false,analytics:'basic',teamSeats:1}},
  { code:'WHS_BASIC', audience:'WHOLESALER', nameHu:'Wholesale Basic', nameEn:'Wholesale Basic', priceMonthly:49, priceYearly:490, currency:'EUR', featured:true,
    ...
    featuresHu:['8 aktív Group Order','1 boost kredit / hó','Buyer demand insight','1,5% Group Order platformdíj','2 felhasználó'], featuresEn:['8 active Group Orders','1 boost credit / month','Buyer demand insights','1.5% Group Order platform fee','2 users'],
    entitlements:{activeGroupOrders:8,groupOrderFeePct:1.5,featuredProfile:false,analytics:'basic',monthlyBoostCredits:1,monthlyLeadCredits:10,teamSeats:2}},
  { code:'WHS_PRO', audience:'WHOLESALER', nameHu:'Wholesale Pro', nameEn:'Wholesale Pro', priceMonthly:129, priceYearly:1290, currency:'EUR',
    ...
    featuresHu:['30 aktív Group Order','Kiemelt profil','5 boost kredit / hó','Haladó demand analytics','1,5% Group Order platformdíj','5 felhasználó'], featuresEn:['30 active Group Orders','Featured profile','5 boost credits / month','Advanced demand analytics','1.5% Group Order platform fee','5 users'],
    entitlements:{activeGroupOrders:30,groupOrderFeePct:1.5,featuredProfile:true,analytics:'advanced',monthlyBoostCredits:5,monthlyLeadCredits:30,teamSeats:5}},
...
export const MONETIZATION_ADDONS: MonetizationAddOn[] = [
  ...
  {code:'GROUP_ORDER_TRANSACTION_FEE',audiences:['MANUFACTURER','WHOLESALER'],nameHu:'Group Order tranzakciós díj',nameEn:'Group Order transaction fee',descriptionHu:'A sikeresen teljesült közös beszerzés értékére számított platformdíj.',descriptionEn:'Platform fee calculated on successfully completed Group Order GMV.',price:null,pricePct:1.5,currency:'EUR',period:'PERCENTAGE'},
  {code:'SUCCESS_FEE',audiences:['BUYER','MANUFACTURER','WHOLESALER'],nameHu:'Tranzakciós díj',nameEn:'Transaction fee',descriptionHu:'A lezárt rendelés GMV-jére számított, 1,5%-os vevői platformdíj.',descriptionEn:'Fixed 1.5% buyer platform fee calculated on completed-order GMV.',price:null,pricePct:1.5,currency:'EUR',period:'PERCENTAGE'},
];
